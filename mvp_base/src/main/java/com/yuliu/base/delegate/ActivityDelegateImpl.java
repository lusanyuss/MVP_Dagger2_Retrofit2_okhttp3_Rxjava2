 ...
 * ================================================
 */
public class ActivityDelegateImpl implements com.yuliu.base.delegate.ActivityDelegate {
    private Activity                              mActivity;
    private com.yuliu.base.delegate.IActivity iActivity;

    public ActivityDelegateImpl(@NonNull Activity activity) {
        this.mActivity = activity;
        this.iActivity = (com.yuliu.base.delegate.IActivity) activity;
    }
