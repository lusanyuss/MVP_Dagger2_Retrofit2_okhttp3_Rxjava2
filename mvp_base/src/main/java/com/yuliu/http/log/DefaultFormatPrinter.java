 ...
 */
package com.yuliu.http.log;

import android.support.annotation.NonNull;
import android.support.annotation.Nullable;
import android.text.TextUtils;

import com.yuliu.utils.CharacterHandler;
import com.yuliu.utils.LogUtils;
...
public class DefaultFormatPrinter implements FormatPrinter {
    ...
    /**
     * 打印网络请求信息, 当网络请求时 {{ okhttp3.RequestBody}} 为 {@code null} 或不可解析的情况
     *
     * @param request
     */
    @Override
    ...
    /**
     * 打印网络响应信息, 当网络响应时 {{ okhttp3.ResponseBody}} 为 {@code null} 或不可解析的情况
     *
     * @param chainMs      服务器响应耗时(单位毫秒)
     * @param isSuccessful 请求是否成功
     * @param code         响应码
